...
🛠️ Tech Stack
    ...
    Styling: Custom CSS with the Montserrat font.

    Icons: Native emojis for a lightweight UI.
...
Installation
    ...
    git clone https://github.com/YOUR_USERNAME/brutalist-tasks.git
    ...
    (Note: This installs all packages listed in the package.json file.)
...
📂 Project Structure
    ...
    src/App.js: Contains the main logic for onboarding, task state management, and filtering.

    src/App.css: Contains the Brutalist design system and responsive media queries.

    public/: Contains static assets like the favicon.ico and index.html.